# Modified from mmsegmentation (https://github.com/open-mmlab/mmsegmentation) Cityscapes default config file
_base_ = ['../_base_/default_runtime.py', '../_base_/datasets/wildscenes_standard.py']
