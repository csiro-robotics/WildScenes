...
Registry modified to include the WildScenes dataset, line 50 modified.
"""
...
DATASETS = Registry(
    'dataset', parent=MMENGINE_DATASETS, locations=['mmseg.datasets', 'wildscenes.mmsegwildscenes.dataset'])
