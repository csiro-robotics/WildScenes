...
# File modified from original file: https://github.com/open-mmlab/mmdetection3d/blob/main/tools/train.py
# Modified to run 3D segmentation on the WildScenes dataset.
import argparse
import logging
import os
